...
This chapter serves as a detailed explanation of \emph{M. extorquens}, more specifically its biological
...
\begin{figure}[H]
    ...
    \caption{Pink \emph{Methylorubrum extorquens} on a leaf in a symbiotic relationship with a plant.}
...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\textwidth]{./media/images/mextorquens_metabolizing_methanol}
